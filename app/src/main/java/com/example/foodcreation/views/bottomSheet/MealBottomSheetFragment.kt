package com.example.foodcreation.views.bottomSheet
...
import com.example.foodcreation.databinding.FragmentMealBottomSheetBinding
import com.example.foodcreation.views.HomeFragment
import com.example.foodcreation.views.MealActivity
...
class MealBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        onBottomSeetDialogclick()
    }

    private fun onBottomSeetDialogclick() {
